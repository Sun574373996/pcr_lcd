...
Page7::Page7(QWidget *parent) : Widget(parent)
{
    ...
    new_dir_btn=new Button;
    new_dir_btn->setParent(this);
    new_dir_btn->setGeometry(0,522,170,78);
    new_dir_btn->setStyleSheet("background-color:red;color:white");
    new_dir_btn->setText(tr("新建文件夹"));
    new_dir_btn->set_press_color(QColor(0,0,0,20),CLICK_BTN);

    new_file_btn=new Button;
    new_file_btn->setParent(this);
    new_file_btn->setGeometry(171,522,173,78);
    new_file_btn->setStyleSheet("background-color:red;color:white");
    new_file_btn->setText(tr("新建程序"));
    new_file_btn->set_press_color(QColor(0,0,0,20),CLICK_BTN);

    open_btn=new Button;
    open_btn->setParent(this);
    open_btn->setGeometry(864,521,160,81);
    open_btn->setStyleSheet("background-color:transparent;color:white;border-style:none");
    ...
    QPixmap pixmap = QPixmap(":/image/background/new_dir_file.jpg").scaled(this->size());
    QPalette palette(this->palette());
    palette.setBrush(QPalette::Background, QBrush(pixmap));
    this->setPalette(palette);
}
void Page7::display_dir(void)
{
...
void Page7::display_dir_file(void)
{
...
void Page7::paintEvent(QPaintEvent *event)
{
    QWidget::paintEvent(event);
}

void Page7::dir_btn_change(int id)
{
...
void Page7::file_btn_change(int id)
{
...
void Page7::jump_page1(void)
{
    qDebug()<<"jump_page1";
    emit page_jump(NEXT_PAGE,7,1);
}
void Page7::jump_page3(void)
{
    qDebug()<<"jump_page3";
    emit page_jump(NEXT_PAGE,7,3);
}
void Page7::refresh_page(void)
{
    display_dir();
}

void Page7::dir_up(void)
{
    dir_page_id--;
    display_dir();
}
void Page7::dir_down(void)
{
    dir_page_id++;
    display_dir();
}
void Page7::file_up(void)
{
    file_page_id--;
    display_dir_file();
}
void Page7::file_down(void)
{
    file_page_id++;
    display_dir_file();
}
